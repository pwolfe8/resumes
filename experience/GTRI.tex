...
\newcommand{\experienceGTRIEdgeMLLong}{
    ...
    \end{itemize}
    Projects that I've used this for include:
    \begin{itemize}
        \item real-time video analytics for security and surveillance
        \item aerial and ground based precision pointing systems
    \end{itemize}
}
